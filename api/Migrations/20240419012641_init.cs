        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Volume24 = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Symbol = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ERC20_ContractAdress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BSC20_ContractAdress = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CryptoTransactions_CryptoCurrencies_CryptoCurrencyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CryptoTransactions_CryptoCurrencyId",
